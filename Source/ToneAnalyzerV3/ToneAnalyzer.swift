...
public class ToneAnalyzer {
    ...
    /**
     ...
     - parameter toneContent: The content for the tone request.
...
extension ToneAnalyzer {
    ...
    public func tone(
        ...
        success: @escaping (ToneAnalysis) -> Void)
    {
        tone(toneContent: .toneInput(toneInput), sentences: sentences, tones: tones, contentLanguage: contentLanguage, acceptLanguage: acceptLanguage, headers: headers, failure: failure, success: success)
    }
    ...
    public func tone(
        ...
        success: @escaping (ToneAnalysis) -> Void)
    {
        tone(toneContent: .text(text), sentences: sentences, tones: tones, contentLanguage: contentLanguage, acceptLanguage: acceptLanguage, headers: headers, failure: failure, success: success)
    }
    ...
    public func tone(
        ...
        success: @escaping (ToneAnalysis) -> Void)
    {
        tone(toneContent: .html(html), sentences: sentences, tones: tones, contentLanguage: contentLanguage, acceptLanguage: acceptLanguage, headers: headers, failure: failure, success: success)
    }
