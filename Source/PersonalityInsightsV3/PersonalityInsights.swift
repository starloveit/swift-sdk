...
public class PersonalityInsights {
    ...
    /**
     ...
     - parameter profileContent: The content for the profile request.
    ...
    /**
     ...
     - parameter profileContent: The content for the profileAsCsv request.
     - parameter contentLanguage: The language of the input text for the request: Arabic, English, Japanese, Korean, or Spanish. Regional variants
       are treated as their parent language; for example, `en-US` is interpreted as `en`.
       The effect of the **Content-Language** parameter depends on the **Content-Type** parameter. When **Content-Type**
       is `text/plain` or `text/html`, **Content-Language** is the only way to specify the language. When
...
extension PersonalityInsights {
    ...
    public func profile(
        ...
        success: @escaping (Profile) -> Void)
    {
        profile(profileContent: .content(content), contentLanguage: contentLanguage, acceptLanguage: acceptLanguage, rawScores: rawScores, consumptionPreferences: consumptionPreferences, headers: headers, failure: failure, success: success)
    }
    ...
    public func profile(
        ...
        success: @escaping (Profile) -> Void)
    {
        profile(profileContent: .text(text), contentLanguage: contentLanguage, acceptLanguage: acceptLanguage, rawScores: rawScores, consumptionPreferences: consumptionPreferences, headers: headers, failure: failure, success: success)
    }
    ...
    public func profile(
        ...
        success: @escaping (Profile) -> Void)
    {
        profile(profileContent: .html(html), contentLanguage: contentLanguage, acceptLanguage: acceptLanguage, rawScores: rawScores, consumptionPreferences: consumptionPreferences, headers: headers, failure: failure, success: success)
    }
    ...
    public func profileAsCsv(
        ...
        success: @escaping (String) -> Void)
    {
        profileAsCsv(profileContent: .content(content), contentLanguage: contentLanguage, acceptLanguage: acceptLanguage, rawScores: rawScores, csvHeaders: csvHeaders, consumptionPreferences: consumptionPreferences, headers: headers, failure: failure, success: success)
    }
    ...
    public func profileAsCsv(
        ...
        success: @escaping (String) -> Void)
    {
        profileAsCsv(profileContent: .text(text), contentLanguage: contentLanguage, acceptLanguage: acceptLanguage, rawScores: rawScores, csvHeaders: csvHeaders, consumptionPreferences: consumptionPreferences, headers: headers, failure: failure, success: success)
    }
    ...
    public func profileAsCsv(
        ...
        success: @escaping (String) -> Void)
    {
        profileAsCsv(profileContent: .html(html), contentLanguage: contentLanguage, acceptLanguage: acceptLanguage, rawScores: rawScores, csvHeaders: csvHeaders, consumptionPreferences: consumptionPreferences, headers: headers, failure: failure, success: success)
    }
}
